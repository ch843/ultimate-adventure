...
const featuredActivities = [
  {
    id: 1,
    imgPath:
      "https://ooelvqpdhbpsjsqbrljg.supabase.co/storage/v1/object/public/ultimate-adventure-prod/adventure-card-photos/HogwartsCanyon.png",
    name: "Canyoneering",
  ...
  },
  {
    id: 2,
    imgPath:
      "https://ooelvqpdhbpsjsqbrljg.supabase.co/storage/v1/object/public/ultimate-adventure-prod/adventure-card-photos/Rappeling.png",
    name: "Climbing",
  ...
  },
  {
    id: 3,
    imgPath:
      "https://ooelvqpdhbpsjsqbrljg.supabase.co/storage/v1/object/public/ultimate-adventure-prod/adventure-card-photos/WhiteWater.png",
    name: "Rafting",
