...
export const adventureService = {
  async getAdventure(request: GetAdventureRequest): Promise<GetAdventureResponse> {
  ...
  async listAdventures(request: ListAdventuresRequest): Promise<ListAdventuresResponse> {
  ...
  async createAdventure(request: CreateAdventureRequest): Promise<CreateAdventureResponse> {
