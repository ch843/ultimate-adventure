...
export type GetActivityCardRequest = z.infer<typeof GetActivityCardRequestSchema>;

export const GetActivityCardResponseSchema = z.object({
  card: AdventureCardSchema,
});

export type GetActivityCardResponse = z.infer<typeof GetActivityCardResponseSchema>;

export const GetAllActivityCardsRequestSchema = z.object({});

export type GetAllActivityCardsRequest = z.infer<typeof GetAllActivityCardsRequestSchema>;
...
export type UpdateActivityCardRequest = z.infer<typeof UpdateActivityCardRequestSchema>;
