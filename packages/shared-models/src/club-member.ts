...
export type GetAllClubMembersRequest = z.infer<typeof GetAllClubMembersRequestSchema>;

export const GetAllClubMembersResponseSchema = z.object({
  members: z.array(ClubMemberSchema),
});

export type GetAllClubMembersResponse = z.infer<typeof GetAllClubMembersResponseSchema>;

export const CreateClubMemberRequestSchema = z.object({
  data: ClubMemberSchema.omit({ id: true }),
});

export type CreateClubMemberRequest = z.infer<typeof CreateClubMemberRequestSchema>;

export const CreateClubMemberResponseSchema = z.object({
  member: ClubMemberSchema,
});

export type CreateClubMemberResponse = z.infer<typeof CreateClubMemberResponseSchema>;
...
export type UpdateClubMemberRequest = z.infer<typeof UpdateClubMemberRequestSchema>;

export const UpdateClubMemberResponseSchema = z.object({
  success: z.boolean(),
});

export type UpdateClubMemberResponse = z.infer<typeof UpdateClubMemberResponseSchema>;

export const DeleteClubMemberRequestSchema = z.object({
  id: z.number(),
});

export type DeleteClubMemberRequest = z.infer<typeof DeleteClubMemberRequestSchema>;

export const DeleteClubMemberResponseSchema = z.object({
  success: z.boolean(),
});

export type DeleteClubMemberResponse = z.infer<typeof DeleteClubMemberResponseSchema>;
